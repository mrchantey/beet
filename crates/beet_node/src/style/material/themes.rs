...
pub fn light_scheme() -> Rule {
	Rule::new()
		...
		.with_token::<colors::OnPrimaryContainer       >(tones::Primary10)
		.with_token::<colors::InversePrimary           >(tones::Primary80)
		.with_token::<colors::Secondary                >(tones::Secondary40)
		.with_token::<colors::OnSecondary              >(tones::Secondary100)
		.with_token::<colors::SecondaryContainer       >(tones::Secondary90)
		.with_token::<colors::OnSecondaryContainer     >(tones::Secondary10)
		.with_token::<colors::Tertiary                 >(tones::Tertiary40)
		.with_token::<colors::OnTertiary               >(tones::Tertiary100)
		.with_token::<colors::TertiaryContainer        >(tones::Tertiary90)
		.with_token::<colors::OnTertiaryContainer      >(tones::Tertiary10)
		.with_token::<colors::Error                    >(tones::Error40)
		.with_token::<colors::OnError                  >(tones::Error100)
		.with_token::<colors::ErrorContainer           >(tones::Error90)
		.with_token::<colors::OnErrorContainer         >(tones::Error10)
		.with_token::<colors::Background               >(tones::Neutral99)
		.with_token::<colors::OnBackground             >(tones::Neutral10)
		.with_token::<colors::Surface                  >(tones::Neutral99)
		.with_token::<colors::OnSurface                >(tones::Neutral10)
		.with_token::<colors::SurfaceVariant           >(tones::NeutralVariant90)
		.with_token::<colors::OnSurfaceVariant         >(tones::NeutralVariant30)
		.with_token::<colors::Outline                  >(tones::NeutralVariant50)
		.with_token::<colors::OutlineVariant           >(tones::NeutralVariant80)
		.with_token::<colors::Shadow                   >(tones::Neutral0)
		.with_token::<colors::Scrim                    >(tones::Neutral0)
		.with_token::<colors::InverseSurface           >(tones::Neutral20)
...
pub fn dark_scheme() -> Rule {
	Rule::new()
		...
		.with_token::<colors::OnPrimaryContainer       >(tones::Primary90)
		.with_token::<colors::InversePrimary           >(tones::Primary40)
		.with_token::<colors::Secondary                >(tones::Secondary80)
		.with_token::<colors::OnSecondary              >(tones::Secondary20)
		.with_token::<colors::SecondaryContainer       >(tones::Secondary30)
		.with_token::<colors::OnSecondaryContainer     >(tones::Secondary90)
		.with_token::<colors::Tertiary                 >(tones::Tertiary80)
		.with_token::<colors::OnTertiary               >(tones::Tertiary20)
		.with_token::<colors::TertiaryContainer        >(tones::Tertiary30)
		.with_token::<colors::OnTertiaryContainer      >(tones::Tertiary90)
		.with_token::<colors::Error                    >(tones::Error80)
		.with_token::<colors::OnError                  >(tones::Error20)
		.with_token::<colors::ErrorContainer           >(tones::Error30)
		.with_token::<colors::OnErrorContainer         >(tones::Error80)
		.with_token::<colors::Background               >(tones::Neutral10)
		.with_token::<colors::OnBackground             >(tones::Neutral90)
		.with_token::<colors::Surface                  >(tones::Neutral10)
		.with_token::<colors::OnSurface                >(tones::Neutral90)
		.with_token::<colors::SurfaceVariant           >(tones::NeutralVariant30)
		.with_token::<colors::OnSurfaceVariant         >(tones::NeutralVariant80)
		.with_token::<colors::Outline                  >(tones::NeutralVariant60)
		.with_token::<colors::OutlineVariant           >(tones::NeutralVariant30)
		.with_token::<colors::Shadow                   >(tones::Neutral0)
		.with_token::<colors::Scrim                    >(tones::Neutral0)
		.with_token::<colors::InverseSurface           >(tones::Neutral90)
