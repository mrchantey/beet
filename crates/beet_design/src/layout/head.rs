...
pub fn Head(
	...
	rsx! {
		...
		<meta property="og:title" content={name.clone()} />
		<meta property="og:type" content="website" />
		// <meta property="og:image" content={image} />
		<meta property="og:description" content={description.clone()} />
		<meta property="og:url" content={homepage.clone()} />

		<meta name="twitter:title" content={name.clone()}>
		...
		<meta name="apple-mobile-web-app-title" content={name.clone()}>
		// <!-- android/pwa -->
		<meta name="mobile-web-app-capable" content="yes">
		<meta name="theme-color" content="#fffff">
		<meta name="application-name" content={name.clone()}>
		// <!-- microsoft -->
