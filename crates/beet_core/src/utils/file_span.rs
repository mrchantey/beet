...
impl FileSpan {
	...
	pub fn new_caller() -> Self {
		Self::new_from_location(core::panic::Location::caller())
	}

	/// Creates a new [`FileSpan`] from a panic [`Location`](core::panic::Location).
	pub fn new_from_location(location: &core::panic::Location) -> Self {
		Self::new(
			location.file(),
