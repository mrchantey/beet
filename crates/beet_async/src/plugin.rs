...
impl bevy::app::Plugin for AsyncPlugin {
...
/// By calling [`AsyncWorld::system_state`] you create a new bridge between an async task
/// and the ecs.
...
impl AsyncWorld {
	...
	/// then call [`AsyncSystemState::bridge`] inside async code whenever you want to access the ECS.
	///
	/// # Example
	/// ```rust
