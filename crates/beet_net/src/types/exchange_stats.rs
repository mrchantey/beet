...
/// The [`exchange_stats`] observer bumps the count on [`EndExchange`]. (The
/// number of requests mid-dispatch is per route, see
/// [`RouteInFlight`](crate::prelude::RouteInFlight).)
