//! Small helpers the `rsx!` and `#[template]` lowerings reach for: dynamic and
//! optional attributes, and a template-capable test world.
use crate::prelude::*;
use beet_core::prelude::*;

/// Build a single HTML attribute as a [`Bundle`], for use as an `rsx!` block
...
/// An HTML attribute that renders only when its value is [`Some`], for use as an
