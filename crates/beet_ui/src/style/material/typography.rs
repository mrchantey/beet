...
pub fn default_typography() -> Vec<(TokenKey, TokenValue)> {
	Rule::new()
		...
		.with_value(FontSizeDisplaySmall, 	Length::Rem(2.25))
		.with_value(FontSizeHeadlineLarge, 	Length::Rem(2.0))
		.with_value(FontSizeHeadlineMedium, Length::Rem(1.75))
		.with_value(FontSizeHeadlineSmall, 	Length::Rem(1.5))
		.with_value(FontSizeTitleLarge, 		Length::Rem(1.375))
		.with_value(FontSizeTitleMedium, 		Length::Rem(1.0))
		.with_value(FontSizeTitleSmall, 		Length::Rem(0.875))
		.with_value(FontSizeBodyLarge, 			Length::Rem(1.0))
		.with_value(FontSizeBodyMedium, 		Length::Rem(0.875))
		.with_value(FontSizeBodySmall, 			Length::Rem(0.75))
		...
		.with_value(LineHeightDisplaySmall, 	Length::Rem(2.75))
		.with_value(LineHeightHeadlineLarge, 	Length::Rem(2.5))
		.with_value(LineHeightHeadlineMedium, Length::Rem(2.25))
		.with_value(LineHeightHeadlineSmall, 	Length::Rem(2.0))
		.with_value(LineHeightTitleLarge, 		Length::Rem(1.75))
		.with_value(LineHeightTitleMedium, 		Length::Rem(1.5))
		.with_value(LineHeightTitleSmall, 		Length::Rem(1.25))
		.with_value(LineHeightBodyLarge, 			Length::Rem(1.5))
		.with_value(LineHeightBodyMedium, 		Length::Rem(1.25))
		.with_value(LineHeightBodySmall, 			Length::Rem(1.0))
		...
		.with_value(LetterSpacingBodyMedium, 			Length::Rem(0.015625))
		.with_value(LetterSpacingBodySmall, 			Length::Rem(0.025))
		...
		.with_value(BodyMedium, 		Typography     { typeface: TypefacePlain.into(), weight: WeightRegular.into(), size: FontSizeBodyMedium.into(),     line_height: LineHeightBodyMedium.into(),     letter_spacing: LetterSpacingBodyMedium.into() })
		.with_value(BodySmall, 			Typography      { typeface: TypefacePlain.into(), weight: WeightRegular.into(), size: FontSizeBodySmall.into(),      line_height: LineHeightBodySmall.into(),      letter_spacing: LetterSpacingBodySmall.into() })
