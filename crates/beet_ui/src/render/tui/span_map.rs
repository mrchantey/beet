...
/// Maps terminal-space cell positions to the entity that rendered content there.
///
...
impl TuiSpanMap {
	...
	/// Look up the entity that owns the cell at the given terminal-space position.
