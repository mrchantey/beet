...
pub struct AwsEcrRepositoryDetails {
	...
	pub encryption_configuration:
		Option<Vec<AwsEcrRepositoryResourceBlockTypeEncryptionConfiguration>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
impl terra::Resource for AwsEcrRepositoryDetails {
	fn resource_type(&self) -> &'static str { "aws_ecr_repository" }
...
pub struct AwsEcsClusterDetails {
	...
	pub service_connect_defaults:
		Option<Vec<AwsEcsClusterResourceBlockTypeServiceConnectDefaults>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
impl terra::Resource for AwsEcsClusterDetails {
	fn resource_type(&self) -> &'static str { "aws_ecs_cluster" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
pub struct AwsEcsServiceDetails {
	...
	pub capacity_provider_strategy:
		Option<Vec<AwsEcsServiceResourceBlockTypeCapacityProviderStrategy>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub deployment_circuit_breaker:
		Option<Vec<AwsEcsServiceResourceBlockTypeDeploymentCircuitBreaker>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub deployment_configuration:
		Option<Vec<AwsEcsServiceResourceBlockTypeDeploymentConfiguration>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub deployment_controller:
		Option<Vec<AwsEcsServiceResourceBlockTypeDeploymentController>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub load_balancer: Option<Vec<AwsEcsServiceResourceBlockTypeLoadBalancer>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub network_configuration:
		Option<Vec<AwsEcsServiceResourceBlockTypeNetworkConfiguration>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub ordered_placement_strategy:
		Option<Vec<AwsEcsServiceResourceBlockTypeOrderedPlacementStrategy>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub placement_constraints:
		Option<Vec<AwsEcsServiceResourceBlockTypePlacementConstraints>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub service_connect_configuration:
		Option<Vec<AwsEcsServiceResourceBlockTypeServiceConnectConfiguration>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub service_registries:
		Option<Vec<AwsEcsServiceResourceBlockTypeServiceRegistries>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub timeouts: Option<Vec<AwsEcsServiceResourceBlockTypeTimeouts>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub volume_configuration:
		Option<Vec<AwsEcsServiceResourceBlockTypeVolumeConfiguration>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub vpc_lattice_configurations:
		Option<Vec<AwsEcsServiceResourceBlockTypeVpcLatticeConfigurations>>,
}
...
impl terra::Resource for AwsEcsServiceDetails {
	fn resource_type(&self) -> &'static str { "aws_ecs_service" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
pub struct AwsEcsTaskDefinitionDetails {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub ephemeral_storage:
		Option<Vec<AwsEcsTaskDefinitionResourceBlockTypeEphemeralStorage>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub placement_constraints:
		Option<Vec<AwsEcsTaskDefinitionResourceBlockTypePlacementConstraints>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub proxy_configuration:
		Option<Vec<AwsEcsTaskDefinitionResourceBlockTypeProxyConfiguration>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub runtime_platform:
		Option<Vec<AwsEcsTaskDefinitionResourceBlockTypeRuntimePlatform>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
impl terra::Resource for AwsEcsTaskDefinitionDetails {
	fn resource_type(&self) -> &'static str { "aws_ecs_task_definition" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
pub struct AwsLbDetails {
	...
	pub minimum_load_balancer_capacity:
		Option<Vec<AwsLbResourceBlockTypeMinimumLoadBalancerCapacity>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
impl terra::Resource for AwsLbDetails {
	fn resource_type(&self) -> &'static str { "aws_lb" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
pub struct AwsLbListenerDetails {
	...
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_request_x_amzn_mtls_clientcert_header_name:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_request_x_amzn_mtls_clientcert_issuer_header_name:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_request_x_amzn_mtls_clientcert_leaf_header_name:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_request_x_amzn_mtls_clientcert_serial_number_header_name:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_request_x_amzn_mtls_clientcert_subject_header_name:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_request_x_amzn_mtls_clientcert_validity_header_name:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_request_x_amzn_tls_cipher_suite_header_name:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_access_control_allow_credentials_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_access_control_allow_headers_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_access_control_allow_methods_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_access_control_allow_origin_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_access_control_expose_headers_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_access_control_max_age_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_content_security_policy_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_strict_transport_security_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	pub routing_http_response_x_content_type_options_header_value:
		Option<SmolStr>,
	/// ## Attribute
	/// `optional`, `computed`
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub default_action:
		Option<Vec<AwsLbListenerResourceBlockTypeDefaultAction>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub mutual_authentication:
		Option<Vec<AwsLbListenerResourceBlockTypeMutualAuthentication>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
impl terra::Resource for AwsLbListenerDetails {
	fn resource_type(&self) -> &'static str { "aws_lb_listener" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
pub struct AwsLbTargetGroupDetails {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub target_failover:
		Option<Vec<AwsLbTargetGroupResourceBlockTypeTargetFailover>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub target_health_state:
		Option<Vec<AwsLbTargetGroupResourceBlockTypeTargetHealthState>>,
}
...
impl terra::Resource for AwsLbTargetGroupDetails {
	fn resource_type(&self) -> &'static str { "aws_lb_target_group" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
pub struct AwsEcsServiceResourceBlockTypeDeploymentConfiguration {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub lifecycle_hook:
		Option<Vec<DeploymentConfigurationResourceBlockTypeLifecycleHook>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
pub struct AwsEcsServiceResourceBlockTypeLoadBalancer {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub advanced_configuration:
		Option<Vec<LoadBalancerResourceBlockTypeAdvancedConfiguration>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
...
pub struct AwsEcsServiceResourceBlockTypeServiceConnectConfiguration {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub service:
		Option<Vec<ServiceConnectConfigurationResourceBlockTypeService>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
...
pub struct AwsEcsServiceResourceBlockTypeVolumeConfiguration {
	...
	pub name: SmolStr,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub managed_ebs_volume:
		Option<Vec<VolumeConfigurationResourceBlockTypeManagedEbsVolume>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
...
pub struct AwsEcsTaskDefinitionResourceBlockTypeVolume {
	...
	pub docker_volume_configuration:
		Option<Vec<VolumeResourceBlockTypeDockerVolumeConfiguration>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub efs_volume_configuration:
		Option<Vec<VolumeResourceBlockTypeEfsVolumeConfiguration>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub s3files_volume_configuration:
		Option<Vec<VolumeResourceBlockTypeS3filesVolumeConfiguration>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
...
pub struct AwsLbListenerResourceBlockTypeDefaultAction {
	...
	pub r#type: SmolStr,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub authenticate_cognito:
		Option<Vec<DefaultActionResourceBlockTypeAuthenticateCognito>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub authenticate_oidc:
		Option<Vec<DefaultActionResourceBlockTypeAuthenticateOidc>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub fixed_response:
		Option<Vec<DefaultActionResourceBlockTypeFixedResponse>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub jwt_validation:
		Option<Vec<DefaultActionResourceBlockTypeJwtValidation>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
pub struct DefaultActionResourceBlockTypeJwtValidation {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub additional_claim:
		Option<Vec<JwtValidationResourceBlockTypeAdditionalClaim>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
...
pub struct ServiceConnectConfigurationResourceBlockTypeLogConfiguration {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub secret_option:
		Option<Vec<LogConfigurationResourceBlockTypeSecretOption>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
...
pub struct ServiceResourceBlockTypeTls {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub issuer_cert_authority:
		Option<Vec<TlsResourceBlockTypeIssuerCertAuthority>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
...
pub struct VolumeConfigurationResourceBlockTypeManagedEbsVolume {
	...
	pub tag_specifications:
		Option<Vec<ManagedEbsVolumeResourceBlockTypeTagSpecifications>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
...
pub struct VolumeResourceBlockTypeEfsVolumeConfiguration {
	...
	pub authorization_config:
		Option<Vec<EfsVolumeConfigurationResourceBlockTypeAuthorizationConfig>>,
}
#[derive(
	Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default,
)]
