...
pub struct AwsDynamodbTableDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub global_secondary_index: Option<
        Vec<AwsDynamodbTableResourceBlockTypeGlobalSecondaryIndex>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub global_table_witness: Option<
        Vec<AwsDynamodbTableResourceBlockTypeGlobalTableWitness>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub import_table: Option<Vec<AwsDynamodbTableResourceBlockTypeImportTable>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub local_secondary_index: Option<
        Vec<AwsDynamodbTableResourceBlockTypeLocalSecondaryIndex>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub on_demand_throughput: Option<
        Vec<AwsDynamodbTableResourceBlockTypeOnDemandThroughput>,
    >,
    /// ## Attribute
    /// `optional`
    #[serde(skip_serializing_if = "Option::is_none")]
    pub point_in_time_recovery: Option<
        Vec<AwsDynamodbTableResourceBlockTypePointInTimeRecovery>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub replica: Option<Vec<AwsDynamodbTableResourceBlockTypeReplica>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub server_side_encryption: Option<
        Vec<AwsDynamodbTableResourceBlockTypeServerSideEncryption>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub warm_throughput: Option<Vec<AwsDynamodbTableResourceBlockTypeWarmThroughput>>,
}
...
pub struct AwsDynamodbTableResourceBlockTypeGlobalSecondaryIndex {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub on_demand_throughput: Option<
        Vec<GlobalSecondaryIndexResourceBlockTypeOnDemandThroughput>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub warm_throughput: Option<
        Vec<GlobalSecondaryIndexResourceBlockTypeWarmThroughput>,
    >,
}
#[derive(Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default)]
...
pub struct AwsDynamodbTableResourceBlockTypeImportTable {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub s3_bucket_source: Option<Vec<ImportTableResourceBlockTypeS3BucketSource>>,
}
#[derive(Clone, Debug, PartialEq, PartialOrd, Serialize, Deserialize, Default)]
