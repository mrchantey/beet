...
impl terra::Resource for AwsApiGatewayRestApiDetails {
	fn resource_type(&self) -> &'static str { "aws_api_gateway_rest_api" }
...
impl terra::Resource for AwsApigatewayv2ApiDetails {
	fn resource_type(&self) -> &'static str { "aws_apigatewayv2_api" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
impl terra::Resource for AwsApigatewayv2IntegrationDetails {
	fn resource_type(&self) -> &'static str { "aws_apigatewayv2_integration" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
		...
		if self.integration_response_selection_expression.is_some() {
			return Err(
				terra::ResourceValidationError::NonEmptyComputedField {
					resource_type: self.resource_type(),
					field_name: "integration_response_selection_expression",
				},
			);
		}
...
impl terra::Resource for AwsApigatewayv2RouteDetails {
	fn resource_type(&self) -> &'static str { "aws_apigatewayv2_route" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
pub struct AwsApigatewayv2StageDetails {
	...
	pub tags_all: Option<Map<SmolStr, SmolStr>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub access_log_settings:
		Option<Vec<AwsApigatewayv2StageResourceBlockTypeAccessLogSettings>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub default_route_settings:
		Option<Vec<AwsApigatewayv2StageResourceBlockTypeDefaultRouteSettings>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub route_settings:
...
impl terra::Resource for AwsApigatewayv2StageDetails {
	fn resource_type(&self) -> &'static str { "aws_apigatewayv2_stage" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
pub struct AwsLambdaFunctionDetails {
	...
	pub dead_letter_config:
		Option<Vec<AwsLambdaFunctionResourceBlockTypeDeadLetterConfig>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub durable_config:
		Option<Vec<AwsLambdaFunctionResourceBlockTypeDurableConfig>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub environment: Option<Vec<AwsLambdaFunctionResourceBlockTypeEnvironment>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub ephemeral_storage:
		Option<Vec<AwsLambdaFunctionResourceBlockTypeEphemeralStorage>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub file_system_config:
		Option<Vec<AwsLambdaFunctionResourceBlockTypeFileSystemConfig>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub image_config:
		Option<Vec<AwsLambdaFunctionResourceBlockTypeImageConfig>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub logging_config:
		Option<Vec<AwsLambdaFunctionResourceBlockTypeLoggingConfig>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub snap_start: Option<Vec<AwsLambdaFunctionResourceBlockTypeSnapStart>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub tenancy_config:
		Option<Vec<AwsLambdaFunctionResourceBlockTypeTenancyConfig>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub timeouts: Option<Vec<AwsLambdaFunctionResourceBlockTypeTimeouts>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub tracing_config:
		Option<Vec<AwsLambdaFunctionResourceBlockTypeTracingConfig>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
impl terra::Resource for AwsLambdaFunctionDetails {
	fn resource_type(&self) -> &'static str { "aws_lambda_function" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
		...
		if self.qualified_invoke_arn.is_some() {
			return Err(
				terra::ResourceValidationError::NonEmptyComputedField {
					resource_type: self.resource_type(),
					field_name: "qualified_invoke_arn",
				},
			);
		}
		if self.response_streaming_invoke_arn.is_some() {
			return Err(
				terra::ResourceValidationError::NonEmptyComputedField {
					resource_type: self.resource_type(),
					field_name: "response_streaming_invoke_arn",
				},
			);
		}
		...
		if self.signing_profile_version_arn.is_some() {
			return Err(
				terra::ResourceValidationError::NonEmptyComputedField {
					resource_type: self.resource_type(),
					field_name: "signing_profile_version_arn",
				},
			);
		}
...
impl terra::Resource for AwsLambdaFunctionUrlDetails {
	fn resource_type(&self) -> &'static str { "aws_lambda_function_url" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
...
impl terra::Resource for AwsLambdaPermissionDetails {
	fn resource_type(&self) -> &'static str { "aws_lambda_permission" }
	fn provider(&self) -> &'static terra::Provider { &terra::Provider::AWS }
	fn validate_definition(
		&self,
	) -> Result<(), terra::ResourceValidationError> {
