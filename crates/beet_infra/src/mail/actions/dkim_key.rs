...
impl EnsureDkimKey {
	...
	async fn generate(bits: u32) -> Result<String> {
	...
	pub fn rotation() -> SecretRotation {
...
/// by a selector the world cannot resolve. SecretRotation is a second selector added
...
pub async fn EnsureDkimKey(
	...
	#[field(default = EnsureDkimKey::BITS)]
	bits: u32,
