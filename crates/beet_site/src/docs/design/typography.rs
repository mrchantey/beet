	...
	rsx! {
		<article>
			...
			<details>
				...
				<p>"Yep its pretty simple! If you want something more styled use Accordion"</p>
			</details>
			<h2>"Paragraphs"</h2>
			...
			<h2>"Lists"</h2>
			<p>"An unordered list, with a nested list:"</p>
			<ul>
				<li>"First item"</li>
				<li>
					"Second item"
			...
			<p>"An ordered list, with a nested list:"</p>
			<ol>
				<li>"First step"</li>
				<li>
					"Second step"
			...
			<address>"This is address text"</address>
