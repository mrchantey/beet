...
/// rather than registered rules, since none is reused elsewhere.
pub fn get() -> impl Scene {
	rsx! {
		<div {inline_class![(common_props::DisplayProp, style::Display::Flex), (common_props::FlexDirectionProp, style::Direction::Vertical), (common_props::AlignItemsProp, style::AlignItems::Center), (common_props::TextAlignProp, style::TextAlign::Center), (common_props::RowGapProp, Length::Rem(1.5))]}>
			...
			<div {inline_class![(common_props::MaxWidth, Length::Rem(34.))]}>
				<div {Classes::new([classes::CARD_FILLED])}>
					...
					<div {inline_class![(common_props::DisplayProp, style::Display::Flex), (common_props::JustifyContentProp, style::JustifyContent::Center), (common_props::ColumnGapProp, Length::Rem(1.))]}>
