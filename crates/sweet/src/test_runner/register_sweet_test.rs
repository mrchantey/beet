...
//! ## How it works
//!
//! 1. `#[sweet::test]` macro generates code calling `register_sweet_test(params, async_body)`
...
///
/// Called by the `#[sweet::test]` macro to register test configuration and the
...
///         sweet::TestCaseParams::new().with_timeout_ms(1000),
///         async { assert!(true); }
///     );
/// }
/// ```
...
/// **Deprecated**: Use [`register_sweet_test`] instead to register both sync and async tests at once.
///
