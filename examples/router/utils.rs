...
pub fn assets_bucket() -> impl BucketProvider {
	cfg_if! {
...
pub fn server_from_cli() -> Result<OnSpawn> {
	cfg_if! {
...
pub async fn head_content(bucket: &Bucket) -> Result<String> {
	let theme_bytes =
...
pub fn article_header_html(fm: &Frontmatter) -> String {
