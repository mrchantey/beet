---
name: test-the-works
description: Maximal project health pass. Run core tests, all tests, the example smoke set and the rsx_site verification in sequence. Use when asked to run 'the works' or fully verify the project.
---
