---
name: docs-rust-sweep
description: Comprehensive public-api quality pass over the core crates, reducing pub visibility and documenting every public item to a deny(missing_docs) standard. Use for crate-wide documentation or visibility sweeps.
---
...
4. mark the crate as done in the checklist below
